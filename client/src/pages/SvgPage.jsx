            ...
            <div className="max-w-7xl mx-auto space-y-10">
                <div className="flex flex-col items-center text-center space-y-6">
                    ...
                    <p className="text-gray-500 text-sm md:text-base max-w-2xl">
                        Manage your custom generated vector graphics and icons.
                        Describe more visions in the AI Studio to grow your collection.
                    </p>
                    ...
                    <div className="w-full max-w-2xl relative group mt-8">
                        ...
                        <input
                            ...
                            placeholder="Search your SVGs by title..."
