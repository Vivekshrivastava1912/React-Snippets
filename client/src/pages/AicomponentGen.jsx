...
const AicomponentGen = () => {
    ...
    const handleContinueToSave = () => {
        ...
        if (currentCode === '// Your AI generated code will appear here...' || !currentCode.trim()) {
            toast.error("No code to save!");
            return;
        }
        navigate('/addsnippet', { state: { code: currentCode, title: prompt.slice(0, 30) } });
    };
    ...
    ), [initialCode, loading, previewTheme, zoom]);
